...
<div class="shopdetails">
    <c:forEach items="${list}" var="parts">
        ...
        <div id="leftbox">
            <div id="showbox">
                <img src="${parts.picture}" width="110" height="130" />
<%--                <img src="../${phone.picture}" width="300" height="330" />--%>
        ...
        <%--        </script>--%>
        <div class="centerbox">
            <p class="imgname" id="model"><td>${parts.model}</td></p>
            <br>
            <div class="iteminfo_buying">
                ...
                <div class="sys_item_spec">
                    ...
                    <dl class="clearfix iteminfo_parameter lh32">
                        <dt>单价</dt>
                        <dd><span class="iteminfo_price">¥ <b class="sys_item_price" id="price"><td>${parts.price}</td></b></span></dd>
                    </dl>
                    <br>
            ...
            <ul id="test1">
                ...
                <div class="sl" style="margin-left: 20px">
                    <input class="min am-btn" name="" type="button" value="-" onclick="danji()"/>
            ...
            <div class="clear"></div>
            <p class="buy"><a href="#" onclick="addcart()">加入购物车</a></p>
            <div class="clear"></div>
        </div>
