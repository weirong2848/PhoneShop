...
<%--                <img src="../${phone.picture}" width="300" height="330" />--%>
        ...
        <%--        </script>--%>
        <div class="centerbox">
            <p style="display: none" id="category"><td>${phone.category}</td></p>
            <p style="display: none" id="commodityId"><td>${phone.commodityId}</td></p>
            ...
            <div class="iteminfo_buying">
                ...
                <div class="sys_item_spec">
                    ...
                    <dl class="clearfix iteminfo_parameter lh32">
                        <dt>单价</dt>
                        <dd><span class="iteminfo_price">¥ <b class="sys_item_price" id="price"><td>${phone.minPrice}</td>

                        </b></span></dd>
                    </dl>
                    <br>
                    <input type="hidden" id="colorList" value="${colorList}">
                        ...
                        <dd>
                            <ul class="sys_spec_text" id="selectcolor">
                                <c:forEach items="${colorList}" var="color">
                                    <li data-aid="3" id="color${color}"><a href="javascript:;" onclick="getColor('${color}')"><td>${color}</td></a><i></i></li>
                                </c:forEach>
                            </ul>
                        </dd>
                    </dl>
                    ...
                    <br>
                    <input type="hidden" id="memoryCapacitList" value="${memoryCapacitList}">
                    <c:if test="${not empty memoryCapacitList}">
                    <dl class="clearfix iteminfo_parameter sys_item_specpara" data-sid="2">
                        <dt>内存容量</dt>
                        <dd>
                            <ul class="sys_spec_text" id="selectmemoryCapacity">
                                <c:forEach items="${memoryCapacitList}" var="memoryCapacit">
                                    <li data-aid="13" id="memoryCapacity${memoryCapacit}"><a href="javascript:;" onclick="getmemoryCapacity('${memoryCapacit}')" ><td>${memoryCapacit}</td></a><i></i></li>
                                </c:forEach>
                            </ul>
                        </dd>
                    </dl>
                    </c:if>
                    <c:if test="${empty memoryCapacitList}">
                    </c:if>
                </div>
                <!--规格属性-->
            </div>
